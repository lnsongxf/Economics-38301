...
function Crews_Econ38301_DecisionRules(w::Float64, E::Array{Float64,2}, K::Array{Float64,2},
    ...
    err = 100
    bound = 10^(-6)
    V_1 = Crews_Econ38301_ValueFuncIter(Pi, Pi, E, K3, beta, delta, xi, thresh, p_LL, p_HH, w)[1]

    # =while= loop
    V_n1 = V_1
    while err > bound
        V_n2 = Crews_Econ38301_ValueFuncIter(V_n1, Pi, E, K3, beta, delta, xi, thresh, p_LL, p_HH, w)[1]
        V_n = V_n1
        V_n1 = V_n2
    ...
    # Get decision rule
    H = Crews_Econ38301_ValueFuncIter(V_n1, Pi, E, K3, beta, delta, xi, thresh, p_LL, p_HH, w)[2]
    return H, p_LL, p_HH
end
